...
class MyTestCase(unittest.TestCase):
    ...
    def testHasPriceAndHasAmountDiscount(self):
        ...
        # print(r.exception, r.response)
        self.assertTrue((not r.isexc) and r.res == [["discount", 5, 10]])
        ...
        self.assertTrue((not r.isexc) and r.res == 29)
    ...
    def testHasPriceAndHasAmountPurchase(self):
        ...
        r = self.m.get_shop_policies(self.u, "shopname")
        # print(r.exception, r.response)
        self.assertTrue((not r.isexc) and r.res == [["purchase", 3]])
        self.m.shopping_carts_add_item(self.u, "itemname1", "shopname", 4)
    ...
    def testHasPriceDiscount(self):
        ...
        r = self.m.get_my_policies(self.u)
        # print(r.exception, r.response)
        self.assertTrue((not r.isexc) and r.res == [[1, "hasPrice", "", 25, 20]])
        r = self.m.add_discount_policy_to_shop(self.u, "shopname", 1)
        self.assertTrue((not r.isexc) and r.res)
        r = self.m.get_shop_policies(self.u, "shopname")
        # print(r.exception, r.response)
        self.assertTrue((not r.isexc) and r.res == [["discount", 1, 20]])
        self.m.shopping_carts_add_item(self.u, "itemname1", "shopname", 4)
        r = self.m.calculate_cart_price(self.u)
        # print(r.exception,r.response)
        self.assertTrue((not r.isexc) and r.res == 20)
        ...
        r = self.m.calculate_cart_price(self.u)
        # print(r.exception, r.response)
        self.assertTrue((not r.isexc) and r.res == 24)
    ...
    def testHasAmount(self):
        ...
        self.assertTrue((not r.isexc) and r.res == [["shopname", [["itemname1", 4]]]])
        r = self.m.validate_purchase_policy(self.u)
        self.assertTrue((not r.isexc) and r.res)
    ...
    def testHasAmount2(self):
        ...
        self.assertTrue((not r.isexc) and r.res)
        r = self.m.get_shop_policies(self.u, "shopname")
        self.assertTrue((not r.isexc) and r.res == [["purchase", 1], ["purchase", 2]])
        r = self.m.shopping_carts_add_item(self.u, "itemname1", "shopname", 4)
        self.assertTrue((not r.isexc) and r.res)
        r = self.m.shopping_carts_check_content(self.u)
        self.assertTrue((not r.isexc) and r.res == [["shopname", [["itemname1", 4]]]])
        ...
        self.assertTrue((not r.isexc) and r.res)
        r = self.m.shopping_carts_check_content(self.u)
        self.assertTrue((not r.isexc) and r.res == [["shopname", [["itemname1", 4], ["itemname2", 4]]]])
        r = self.m.validate_purchase_policy(self.u)
        self.assertTrue((not r.isexc) and r.res)
    ...
    def testOr(self):
        ...
        self.assertTrue((not r.isexc) and r.res)
        r = self.m.shopping_carts_check_content(self.u)
        self.assertTrue((not r.isexc) and r.res == [["shopname", [["itemname2", 4]]]])
        r = self.m.validate_purchase_policy(self.u)
        self.assertTrue((not r.isexc) and r.res)
    ...
    def testNot(self):
        ...
        self.assertTrue((not r.isexc) and r.res)
        r = self.m.get_my_policies(self.u)
        self.assertTrue((not r.isexc) and r.res == [[1, "hasAmount", "itemname1", 4, 10], [2, "not", 1]])
        r = self.m.add_purchase_policy_to_shop(self.u, "shopname", 2)
        self.assertTrue((not r.isexc) and r.res)
        r = self.m.get_shop_policies(self.u, "shopname")
        self.assertTrue((not r.isexc) and r.res == [["purchase", 2]])
        r = self.m.validate_purchase_policy(self.u)
        self.assertTrue((not r.isexc) and r.res)
        r = self.m.shopping_carts_add_item(self.u, "itemname1", "shopname", 4)
        self.assertTrue((not r.isexc) and r.res)
    ...
    def testComplicated(self):
        ...
        r = self.m.calculate_cart_price(self.u)
        self.assertTrue((not r.isexc) and r.res == 58.4)
        self.m.shopping_carts_delete_item(self.u, "itemname1", "shopname", 15)
        r = self.m.calculate_cart_price(self.u)
        self.assertTrue((not r.isexc) and r.res == 28.6)
