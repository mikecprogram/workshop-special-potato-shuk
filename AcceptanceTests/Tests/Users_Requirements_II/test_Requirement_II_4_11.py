...
class MyTestCase(unittest.TestCase):
    ...
    def testGood(self):
        ...
        self.assertEqual(r.res,{"founder":"username","managers":[],"owners":[]}, r.exc)
        self.m.shop_owner_assignment(self.u, "shopname", "username2")
        r = self.m.shops_roles_info_request(self.u, "shopname")
        self.assertTrue((not r.isexc), r.exc)
        self.assertEqual(r.res,{"founder":"username","managers":[],"owners":["username2"]}, r.exc)


        self.m.shop_manager_assignment(self.u, "shopname", "username3")
        r = self.m.shops_roles_info_request(self.u, "shopname")
        self.assertTrue((not r.isexc), r.exc)
        self.assertEqual(r.res,{"founder":"username","managers":["username3"],"owners":["username2"]}, r.exc)
